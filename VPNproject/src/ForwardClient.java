...
public class ForwardClient
{
    ...
    //通过handshake学到的Session Port/Host以及sessionKey/IV
    private static int sessionPort;
    private static String sessionHost;
    public static byte[] sessionKeyBytes;
    ...
    private static void doHandshake(Socket handshakeSocket) throws Exception {
        ...
        sessionKeyBytes = clientHandshake.sessionKeyBytes;
        sessionIV = clientHandshake.sessionIV;
    ...
    public static void main(String[] args)
    {
        try {
            ...
            arguments.setDefault("targetport", "6789");
            arguments.setDefault("targethost", DEFAULTHANDSHAKEHOST);
            arguments.setDefault("proxyport", "12345");
